...
void joker_fix(string &hand){
    char most_common = hand[0];
    int jokers = std::count(hand.begin(), hand.end(), 'J');
    if(most_common == 'J') {
        most_common = hand[jokers];
    }
    auto it = hand.find('J');
    if(it != string::npos){
        hand.erase(it, jokers);
    }
    hand.insert(0, jokers, most_common);
}
...
int compareHands(string h1, string h2){
    ...
    sort(h1_sorted.begin(), h1_sorted.end(), [&h1](char c1, char c2)
         {
             if(count(h1.begin(), h1.end(), c1) == count(h1.begin(), h1.end(), c2)){
                 return c1 > c2;
             }
    ...
    sort(h2_sorted.begin(), h2_sorted.end(), [&h2](char c1, char c2)
         {
            if(count(h2.begin(), h2.end(), c1) == count(h2.begin(), h2.end(), c2)){
                return c1 > c2;
            }
    ...
    if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[0]) > std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[0])){
        return true;
    }
    if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[0]) < std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[0])){
        return false;
    ...
    if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[0]) == 3){
        if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[3]) > std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[3])){
            return true;
        }
        if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[3]) < std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[3])){
            return false;
    ...
    if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[0]) == 2){
        if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[2]) > std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[2])){
            return true;
        }
        if(std::count(h1_sorted.begin(), h1_sorted.end(), h1_sorted[2]) < std::count(h2_sorted.begin(), h2_sorted.end(), h2_sorted[2])){
            return false;
